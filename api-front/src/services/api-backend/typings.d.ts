declare namespace API {
  ...
  type authPassUserCodeUsingPOSTParams = {
    /** code */
    code?: string;
  };
  ...
  type BaseResponsePageAllInterfaceInfoVo = {
    code?: number;
    data?: PageAllInterfaceInfoVo;
    message?: string;
  };
  ...
  type getAllInterfaceInfoByPageUsingGETParams = {
    availablePieces?: string;
    charging?: number;
    createTime?: string;
    current?: number;
  ...
  type getAuthByUserIdUsingGETParams = {
    /** id */
    id?: number;
  };
  ...
  type getPassUserTypeUsingPOSTParams = {
    /** username */
    username?: string;
  };
  ...
  type InterfaceInfoInvokRequest = {
    id?: number;
    method?: string;
    url?: string;
  ...
  type oauth2LoginUsingPOSTParams = {
    /** type */
    type: string;
  };
  ...
  type updateAuthStatusUsingGETParams = {
    /** id */
    id: number;
  };

  type updateUserPassUsingPOSTParams = {
    /** password */
    password?: string;
  };
  ...
  type userLoginByPwdUsingPOSTParams = {
    userAccount?: string;
    userPassword?: string;
  };
